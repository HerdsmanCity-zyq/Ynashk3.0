...
public class DateTimeUtils {
     ...
     * 返回当前日期(Date类型)
     */
    public static Date getCurrentLocalDateAsDate() {
        return Date.from(getCurrentLocalDate().atStartOfDay(ZoneId.systemDefault()).toInstant());
    }
     ...
     * 返回当前日期时间(Date类型)
     */
    public static Date getCurrentLocalDateTimeAsDate() {
        return Date.from(getCurrentLocalDateTime().atZone(ZoneId.systemDefault()).toInstant());
    }
