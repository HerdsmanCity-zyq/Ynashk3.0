...
(function($){
function init(_44c){
var _44d=$("<span class=\"spinner\">"+"<span style='margin: 0px;' class=\"spinner-arrow\">"+"<span style='margin: 0px;' class=\"spinner-arrow-up   \"></span>"+"<span style='margin: 0px;'  class=\"spinner-arrow-down     \"></span>"+"</span>"+"</span>").insertAfter(_44c);
